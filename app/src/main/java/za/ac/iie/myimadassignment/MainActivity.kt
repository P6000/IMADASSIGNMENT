package za.ac.iie.myimadassignment
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        suggestButton.setOnClickListener {
            ...
            val suggestion = when (inputTime) {
                "morning" -> "Suggested Meal: Breakfast : Eggs"
                "mid-morning" -> "Suggested Meal: Light snack : Fruit"
                "afternoon" -> "Suggested Meal: Lunch : Sandwich)"
                "mid-afternoon" -> "Suggested Meal: Light snack : Yogur"
                "dinner" -> "Suggested Meal: Main course : Pasta"
                "after dinner" -> "Suggested Meal: Dessert : Ice Cream"
